...
class TestAntiCheatResult:
    ...
    def test_create_accept_result(self):
        ...
        assert result.action == AntiCheatAction.ACCEPT
    ...
    def test_create_flag_result(self):
        ...
        assert result.action == AntiCheatAction.FLAG
    ...
    def test_create_reject_result(self):
        ...
        assert result.action == AntiCheatAction.REJECT
    ...
    def test_immutability(self):
        ...
        try:
            result.action = AntiCheatAction.REJECT  # type: ignore[misc]
