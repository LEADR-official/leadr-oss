...
# other values from the config, defined by the needs of env.py, can be acquired as needed
...
def do_run_migrations(connection: Connection) -> None:
    ...
    This is called from run_migrations_online via run_sync.
    """
...
async def run_async_migrations() -> None:
    ...
    async with connectable.connect() as connection:
        # Run migrations in sync mode using run_sync
        # This is necessary because Alembic's migration operations are synchronous
...
def run_migrations_online() -> None:
    ...
    This is the entry point called by Alembic.
    """
